...
def iou_and_dice_v2(labels, predictions, is_onehot=True, average=True):
    ...
    # Compute metrics
    metrics_dict = {
        general_keys.DICE_ENDO_KEY: 2*inter_area_endo/sum_area_endo,
        general_keys.IOU_ENDO_KEY: inter_area_endo/(sum_area_endo-inter_area_endo),
        general_keys.DICE_EPI_KEY: 2*inter_area_epi/sum_area_epi,
        general_keys.IOU_EPI_KEY: inter_area_epi/(sum_area_epi-inter_area_epi),
        general_keys.DICE_MYO_KEY: 2*inter_area_myo/sum_area_myo,
        general_keys.IOU_MYO_KEY: inter_area_myo/(sum_area_myo-inter_area_myo)
    }
